...
class Equipment(TimeStampedModel):
    ...
    rental_price=models.DecimalField(max_length=10,decimal_places=2,verbose_name="equipment price")

    deposit=models.DecimalField(max_digits=10,verbose_name="equipment deposit")

    business=models.ForeignKey("business.RentalBusiness",on_delete=models.CASCADE,related_name="equipment",verbose_name="rental business")
